...
var LABELS = {
  TL: {
    ...
    tsrLoginSection: 'TSR Login (Telepono + PIN)',
    managerLoginSection: 'Manager Login (Google)',
    googleSignIn: 'Buksan gamit ang Vienovo Google email',
    openingGoogle: 'Binubuksan ang Google...',
    googleLoginFailed: 'Hindi makapag-login sa Google. Subukan ulit.',
  ...
  BIS: {
    ...
    tsrLoginSection: 'TSR Login (Telepono + PIN)',
    managerLoginSection: 'Manager Login (Google)',
    googleSignIn: 'Abli gamit ang imong Vienovo Google email',
    openingGoogle: 'Gina-abli ang Google...',
    googleLoginFailed: 'Dili maka-login sa Google. Sulayi pag-usab.',
  ...
  EN: {
    ...
    tsrLoginSection: 'TSR Login (Phone + PIN)',
    managerLoginSection: 'Manager Login (Google)',
    googleSignIn: 'Open with your Vienovo Google email',
